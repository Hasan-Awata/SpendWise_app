...
const _TransactionModeltransactionTypeEnumValueMap = {
  'addition': 0,
  'dedduction': 1,
};
const _TransactionModeltransactionTypeValueEnumMap = {
  0: enTransactionType.addition,
  1: enTransactionType.dedduction,
};
...
extension TransactionModelByIndex on IsarCollection<TransactionModel> {
  Future<TransactionModel?> getByLocalId(String localId) {
    return getByIndex(r'localId', [localId]);
  }

  TransactionModel? getByLocalIdSync(String localId) {
  ...
  Future<List<TransactionModel?>> getAllByLocalId(List<String> localIdValues) {
    final values = localIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'localId', values);
  }

  List<TransactionModel?> getAllByLocalIdSync(List<String> localIdValues) {
    final values = localIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByLocalId(TransactionModel object) {
    return putByIndex(r'localId', object);
  }

  Id putByLocalIdSync(TransactionModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'localId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByLocalId(List<TransactionModel> objects) {
    return putAllByIndex(r'localId', objects);
  }

  List<Id> putAllByLocalIdSync(List<TransactionModel> objects,
      {bool saveLinks = true}) {
...
extension TransactionModelQueryFilter
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      transactionTypeEqualTo(enTransactionType value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
    ...
    enTransactionType lower,
    enTransactionType upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryWhereDistinct
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct> distinctByLocalId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct>
      distinctByWalletLocalId({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, String, QQueryOperations> localIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, enTransactionType, QQueryOperations>
  ...
  QueryBuilder<TransactionModel, int?, QQueryOperations> walletIdProperty() {
    return QueryBuilder.apply(this, (query) {
