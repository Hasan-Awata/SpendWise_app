CREATE TABLE [Ledger].[Transactions] (
    ...
    CONSTRAINT [FK_Transactions_Expenses] FOREIGN KEY ([ExpenseID]) REFERENCES [Ledger].[Expenses] ([ExpenseID]),
    ...
    CONSTRAINT [FK_Transactions_Incomes] FOREIGN KEY ([IncomeID]) REFERENCES [Ledger].[Incomes] ([IncomeID]),
